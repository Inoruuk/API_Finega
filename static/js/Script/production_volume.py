...
def prod_nb(debut: str, fin: str, param: list, filtre_long: int=0):
	...
	for item in query:
		for sections in item['InfosSciage']['InfosSciage']:
			nb_total += sections['NombreProduits'] * sections['Largeur'] * sections['Longueur'] * sections['Epaisseur'] / 1000000000
			...
			if sections['NombreProduits']:
				...
				if section in param:
					if sections['Info'] & 1:
						res[section]['M'] += sections['NombreProduits'] * sections['Largeur'] * sections['Longueur'] * sections['Epaisseur'] / 1000000000
					else:
						res[section]['D'] += sections['NombreProduits'] * sections['Largeur'] * sections['Longueur'] * sections['Epaisseur'] / 1000000000
	for item in res:
